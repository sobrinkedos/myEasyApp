...
const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    label: 'Produtos',
    children: [
      { icon: 'box', label: 'Produtos', path: '/products' },
      { icon: 'tag', label: 'Categorias', path: '/categories' },
      { icon: 'chefHat', label: 'Receitas', path: '/recipes' },
      { icon: 'egg', label: 'Insumos', path: '/ingredients' },
      { icon: 'warehouse', label: 'Estoque', path: '/stock' },
      { icon: 'clipboardCheck', label: 'Conferências', path: '/appraisals' },
      { icon: 'calculator', label: 'CMV', path: '/cmv' },
    ],
  },
  {
    icon: 'chartBar',
    label: 'Relatórios',
    children: [
      { icon: 'trendingUp', label: 'Vendas', path: '/reports/sales' },
      { icon: 'packageCheck', label: 'Estoque', path: '/reports/stock' },
      { icon: 'dollarSign', label: 'Financeiro', path: '/reports/financial' },
      { icon: 'activity', label: 'Performance', path: '/reports/performance' },
    ],
  },
  {
    icon: 'cog',
    label: 'Configurações',
    children: [
      { icon: 'store', label: 'Estabelecimento', path: '/settings/establishment' },
      { icon: 'userCircle', label: 'Perfil', path: '/settings/profile' },
      { icon: 'users', label: 'Usuários', path: '/settings/users' },
